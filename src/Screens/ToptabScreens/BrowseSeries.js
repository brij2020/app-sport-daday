...
const International = () => {
    return (
        <ScrollView style={{ backgroundColor: Colors.LIGHT_SKY, flex: 1 }}>
            <View>
                <Text style={styles.date}>August 2019</Text>
            ...
            <View>
                <Text style={styles.date}>September 2021</Text>
                <View style={styles.section}>
                    <Text style={styles.sub_title}>Englang tour of Pakistan, 2022</Text>
                    <Text style={styles.from_date}>Sep 14 - Dec 08</Text>
                </View>
            </View>
            <View>
                <Text style={styles.date}>October 2022</Text>
                <View style={styles.section}>
            ...
            <View>
                <Text style={styles.date}>November 2022</Text>
                <View style={styles.section}>
                    <Text style={styles.sub_title}>ICC Cricket World Cup League Two 2019-23</Text>
                    <Text style={styles.from_date}>Aug 14 - Dec 08</Text>
                </View>
            ...
            <View>
                <Text style={styles.date}>December 2022</Text>
                <View style={styles.section}>
                    <Text style={styles.sub_title}>ICC Cricket World Cup League Two 2019-23</Text>
                    <Text style={styles.from_date}>Aug 14 - Dec 08</Text>
                </View>
...
const Domestic = () => {
    return (
        <ScrollView style={{ backgroundColor: Colors.LIGHT_SKY, flex: 1 }}>
            <View>
                <Text style={styles.date}>September 2022</Text>
                <View style={styles.section}>
                    <Text style={styles.sub_title}>ICC Cricket World Cup League Two 2019-23</Text>
                    <Text style={styles.from_date}>Aug 14 - Dec 08</Text>
                </View>
